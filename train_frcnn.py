...
sys.setrecursionlimit(40000)  # 设置递归调用深度
...
parser.add_option("--config_filename", dest="config_filename", help="Location to store all the metadata related to the"
...
for epoch_num in range(num_epochs):
    ...
    while True:
        try:
            ...
            X, Y, img_data = next(data_gen_train)  # 图片像素矩阵,否包含对象,第二个是回归梯度,增强后的图片信息
